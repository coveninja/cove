...
val CoveJson: Json = Json {
    // The Go backend adds fields freely and this client is not always rebuilt
    // in lockstep with it.
    ignoreUnknownKeys = true

    // Go marshals absent optional values as null rather than omitting them.
    explicitNulls = false
    ...
    // merge, so an omitted field is persisted as its Go zero value: a user whose
