...
| --- | ---: |
| English (`en`) | 100.0% (653/653 messages) |
| Português (`pt`) | 100.0% (653/653 messages) |
| Türkçe (`tr`) | 100.0% (653/653 messages) |
| UI source audit | 100.0% (1303 localized call sites, 0 unlocalized literals) |
<!-- i18n-coverage:end -->
